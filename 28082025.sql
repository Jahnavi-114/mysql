...
SELECT COUNT(*) AS non_hr_admin_employees
FROM employee
...
#2. Departments where max salary is exactly 500000
...
SELECT emp_dept, COUNT(*) AS employee_count, SUM(emp_salary) AS total_salary
FROM employee
GROUP BY emp_dept
